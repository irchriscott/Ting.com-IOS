...
struct URLs {
    static let hostEndPoint                 = "http://192.168.1.6:8000" //ITSAppUsesNonExemptEncryption 192.168.91.1
    static let uploadEndPoint               = "http://192.168.1.6:8000/tinguploads/"
    static let endPoint                     = "http://192.168.1.6:8000/api/v1/"

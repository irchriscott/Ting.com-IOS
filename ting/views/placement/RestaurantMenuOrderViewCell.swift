//
//  RestaurantMenuOrderViewCell.swift
//  ting
//
...
class RestaurantMenuOrderViewCell: UICollectionViewCell {
    ...
    let orderButton: UIButton = {
        let view = UIButton()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.titleLabel?.text = "Order Now".uppercased()
    ...
    private func setup() {
        ...
        orderButton.setTitle("Order Now".uppercased(), for: .normal)
        orderButton.setTitleColor(Colors.colorWhite, for: .normal)
        orderButton.titleLabel?.font = UIFont(name: "Poppins-SemiBold", size: 16)!
        
        orderButton.setLinearGradientBackgroundColorElse(colorOne: Colors.colorPrimary, colorTwo: Colors.colorPrimaryDark, frame: CGRect(x: 0, y: 0, width: bounds.width, height: 55))
        ...
        menuAboutView.addSubview(orderButton)
        ...
        menuAboutView.addConstraintsWithFormat(format: "H:|[v0]|", views: orderButton)
        ...
        if let menu = self.restaurantMenu {
            ...
            if (menu.menu?.isCountable)! && Double((menu.menu?.price)!) != Double((menu.menu?.lastPrice)!) {
                menuAboutView.addConstraintsWithFormat(format: "V:|[v0(\(menuNameHeight))]-4-[v1]-4-[v2]-4-[v3(0.5)]-8-[v4(\(quantityRect.height))]-0-[v5(\(priceRect.height))]-0-[v6(\(lastPriceRect.height))]-8-[v7(0.5)]-8-[v8(26)]-8-[v9(50)]-12-|", views: menuNameView, menuRating, menuDescriptionView, separatorOne, restaurantMenuQuantityTextView, restaurantMenuPriceTextView, restaurantMenuLastPriceTextView, separatorTwo, menuClassView, orderButton)
            } else if !(menu.menu?.isCountable)! && Double((menu.menu?.price)!) != Double((menu.menu?.lastPrice)!) {
                menuAboutView.addConstraintsWithFormat(format: "V:|[v0(\(menuNameHeight))]-4-[v1]-4-[v2]-4-[v3(0.5)]-8-[v4(\(priceRect.height))]-0-[v5(\(lastPriceRect.height))]-8-[v6(0.5)]-8-[v7(26)]-8-[v8(50)]-12-|", views: menuNameView, menuRating, menuDescriptionView, separatorOne, restaurantMenuPriceTextView, restaurantMenuLastPriceTextView, separatorTwo, menuClassView, orderButton)
            } else if (menu.menu?.isCountable)! && !(Double((menu.menu?.price)!) != Double((menu.menu?.lastPrice)!)) {
                menuAboutView.addConstraintsWithFormat(format: "V:|[v0(\(menuNameHeight))]-4-[v1]-4-[v2]-4-[v3(0.5)]-8-[v4(\(quantityRect.height))]-0-[v5(\(priceRect.height))]-8-[v6(0.5)]-8-[v7(26)]-8-[v8(50)]-12-|", views: menuNameView, menuRating, menuDescriptionView, separatorOne, restaurantMenuQuantityTextView, restaurantMenuPriceTextView, separatorTwo, menuClassView, orderButton)
            } else {
                menuAboutView.addConstraintsWithFormat(format: "V:|[v0(\(menuNameHeight))]-4-[v1]-4-[v2]-4-[v3(0.5)]-8-[v4(\(priceRect.height))]-8-[v5(0.5)]-8-[v6(26)]-8-[v7(50)]-12-|", views: menuNameView, menuRating, menuDescriptionView, separatorOne, restaurantMenuPriceTextView, separatorTwo, menuClassView, orderButton)
            }
        }
        ...
        let staticValue: CGFloat = 12 + 1 + 4 + 4 + 1 + 8 + 8 + 8 + 8 + 26 + 50 + 12
